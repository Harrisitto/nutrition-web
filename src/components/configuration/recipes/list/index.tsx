    ...
    <ul className="flex flex-row flex-wrap justify-around gap-3">
      ...
      .map((recipe) => {
        ...
        return (
          <li
            key={recipe.id}
            className="group w-80 cursor-pointer overflow-hidden rounded-xl border bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
            ...
            <div className="grid grid-cols-[1fr_1.2fr] gap-4 p-4">
              ...
              <div className="flex min-w-0 flex-col gap-3">
                <div className="min-w-0">
                  <h3 className="max-h-12 overflow-hidden text-base font-semibold uppercase leading-snug text-slate-900 break-words">
                    {recipe.name}
                  </h3>
                </div>
