...
import { RenderCommandGroup } from "./renderCommandGroup";
...
export const TableCommands = () => {
    ...
    const tableNavigationEntries = Object.entries(appControls.tableNavigation) as Array<
        [keyof typeof appControls.tableNavigation, string]
    >;
    const selectOptionsEntries = Object.entries(appControls.selectOptions) as Array<
        [keyof typeof appControls.selectOptions, string]
    >;
    const commentsEditorEntries = Object.entries(appControls.commentsEditor) as Array<
        [keyof typeof appControls.commentsEditor, string]
    >;
